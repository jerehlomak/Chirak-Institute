...
const DeleteLessonPlan = ({ setModalOn, setChoice }) => {
  ...
  return (
    <div className='bg-[#523636] opacity-95 fixed inset-0 z-50   '>
      <div className='flex h-screen justify-center items-center '>
        <div className='flex-col justify-center  bg-white opacity-100 py-12 px-24 rounded-xl '>
